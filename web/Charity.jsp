...
<html class="no-js">
    <head>
        ...
        <%
        if (request.getParameter("Charity_success") != null) {%>
    <script>alert('Charity Registration Success ');</script>  
    <%}
    %>
        <%
        if (request.getParameter("not") != null) {%>
    <script>alert('Charity Registration Not Approved ');</script>  
    <%}
    %>
        <%
    ...
    <body>
                    ...
                    <div class="container">
                        ...
                        <div id="navbar" class="navbar-collapse collapse pull-right">
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li><a class="is-active" href="Charity.jsp">Charity</a></li>
        ...
        <div class="page-heading text-center">
            ...
            <div class="container ">
                ...
                <h1 class="page-title">Charity Login<span class="title-under"></span></h1>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="h-100 d-flex align-items-center justify-content-center">
                            ...
                            <form action="Charity_log.jsp" method="get">
                            <center>
                                <div class="row">
                                ...
                                <a href="Charity_reg.jsp">New Charity Registration</a>
                            </center></form>
