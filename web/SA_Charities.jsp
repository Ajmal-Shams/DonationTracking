        ...
        <%@page import="java.util.*" %>
            <%@page import="DonationTracking.SQLconnection" %>
                <% ArrayList rows=new ArrayList(); String errMsg=null; Connection con=null; try {
                    ...
                    <head>
                        <meta charset="utf-8">
                        <title>DONATION TRACKING SYSTEM - All Charities</title>
                    ...
                    <body>
                                    ...
                                    <div class="container">
                                        ...
                                        <div id="navbar" class="navbar-collapse collapse pull-right">
                                            <ul class="nav navbar-nav">
                                                ...
                                                <li><a class="is-active" href="SA_Charities.jsp">Charities</a></li>
                        ...
                        <div class="page-heading text-center">
                            <div class="container">
                                <h1 class="page-title">All Charities <span class="title-under"></span></h1>
                            </div>
                        </div>
                        ...
                        <div class="main-container animated">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h4 class="pull-right">Total Charities: <strong>
                                                <%=rows.size()%>
                                            </strong></h4>
                                        <form action="delete_entity.jsp" method="post"
                                            onsubmit="return confirm('Are you sure you want to delete selected charities?');">
                                                            ...
                                                            <% for (int i=0; i < rows.size(); i++) { %>
                                                                <% String[] r=(String[]) rows.get(i); %>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <a href="delete_entity.jsp?type=charity&id=<%=r[0]%>"
                                                                                class="btn btn-danger btn-xs"
                                                                                onclick="return confirm('Delete this charity?')">Delete</a>
                                                                        </td>
                                                                    </tr>
                                                                    <% } %>
                                                                        <% } %>
