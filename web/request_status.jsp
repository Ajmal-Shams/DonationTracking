                                    ...
                                    <% } %>
                                        ...
                                        <body>
                                                    ...
                                                    <div class="navbar-main">
                                                        <div class="container">
                                                            <div class="navbar-header"><button type="button"
                                                                    ...
                                                                    class="navbar-brand"
                                                                    href="Charity_home.jsp">DONATION TRACKING SYSTEM</a>
                                                            </div>
                                                            <div id="navbar"
                                                                ...
                                                                <ul class="nav navbar-nav">
                                                                    ...
                                                                    <li><a href="request_donation.jsp">Request
                                                                            Donation</a></li>
                                                                    <li><a class="is-active"
                                                                            href="request_status.jsp">Request Status</a>
                                                                    </li>
                                                                    <li><a href="CDonations_Details.jsp">Donations</a>
                                                                    </li>
                                                                    <li><a href="CTransactions.jsp">Transactions</a>
                                                                    </li>
                                            ...
                                            <div class="page-heading text-center">
                                                <div class="container">
                                                    <h1 class="page-title">Request Status<span
                                            ...
                                            <div class="main-container">
                                                <div class="container">
                                                    ...
                                                    <table id="customers">
                                                        ...
                                                        <tbody>
                                                            <% Object ci=session.getAttribute("cid"); if (ci !=null) {
                                                                String c=ci.toString(); Connection conn=null; try {
                                                                conn=SQLconnection.getconnection(); if (conn !=null) {
                                                                Statement st=conn.createStatement(); String
                                                                query="SELECT * FROM donation_req WHERE cid='" + c
                                                                + "' ORDER BY id DESC" ; ResultSet
                                                                rs=st.executeQuery(query); while (rs.next()) { String
                                                                id=rs.getString("id"); String
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><img src="campic.jsp?id=<%=cpid%>" height="100"
                                                                            width="100"></td>
                                                                    <td>
                                                                        <%=rs.getString("amount")%>
                                                                    </td>
                                                                ...
                                                                <div class="footer-col">
                                                                    ...
                                                                    <div class="footer-content">
                                                                        <p>The aim of this project is to develop a
                                                                            system to track donation. The users are
                                                                            admin, donor and charity. This system helps
                                                                            the donors to track their donation. This
                                                                            system consisted 5 modules. Besides that,
                                                                            this system also helps the charity request
                                                                            for donation. Meanwhile, the admin will
                                                                            manage the charity and donors.</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
