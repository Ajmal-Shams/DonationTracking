<%-- 
    Document   : Graph
    Created on : Nov 22, 2022, 9:21:49 AM
    Author     : Murthi
--%>
    ...
    <body>
        ...
        <div class="page-heading text-center">
            ...
            <div class="container ">
                ...
                <h1 class="page-title">Graph<span class="title-under"></span></h1>
        ...
        <%
                ...
                ResultSet rs0 = st.executeQuery("SELECT COUNT(id) AS transValue FROM  transaction");
                rs0.next();
                String transValue= rs0.getString("transValue");
                ResultSet rs = st1.executeQuery("SELECT COUNT(id) AS DonorValue FROM  donor_reg");
                rs.next();
                String DonorValue= rs.getString("DonorValue");
            ...
            <script>
                window.onload = function () {
                    ...
                    var chart = new CanvasJS.Chart("chartContainer", {
                        ...
                        title: {
                            text: "Total Donors Vs Transactions"
                        },
                        legend: {
                            cursor: "pointer",
                        ...
                        data: [{
                                ...
                                indexLabel: "{label} {y}",
                                dataPoints: [
                                    {y: <%=DonorValue%>, name: "Total Donors"},
                                    {y: <%=transValue%>, name: "Total Transactions"}
