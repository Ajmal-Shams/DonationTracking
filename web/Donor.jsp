...
<html class="no-js">
    ...
    <%
        if (request.getParameter("Donor_success") != null) {%>
    <script>alert('Donor Registration Success ');</script>  
    <%}
    %>
    <%
        if (request.getParameter("Authentication_Failed") != null) {%>
    <script>alert('Authentication Failed - Incorrect Username and Password');</script>  
    <%}
    %>
    ...
    <body>
                    ...
                    <div class="container">
                        ...
                        <div id="navbar" class="navbar-collapse collapse pull-right">
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li><a class="is-active" href="Donor.jsp">Donor</a></li>
        ...
        <div class="page-heading text-center">
            ...
            <div class="container ">
                ...
                <h1 class="page-title">Donor Login<span class="title-under"></span></h1>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="h-100 d-flex align-items-center justify-content-center">
                        ...
                        <form action="donor_log.jsp" method="get">
                            <center>
                                <div class="row">

                                    <div class="form-group pull-center">
                                        <input type="email" name="name" class="form-control" placeholder="Email*" required style="width: 250px">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group pull-center">
                                ...
                                <a href="donor_reg.jsp">New Donor Registration</a>
                            </center></form>
