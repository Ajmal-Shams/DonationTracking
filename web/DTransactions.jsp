<%-- 
    Document   : DTransactions
    Created on : Nov 20, 2022, 10:20:58 PM
    Author     : Murthi
--%>
    ...
    <body>
                    ...
                    <div class="container">
                        ...
                        <div id="navbar" class="navbar-collapse collapse pull-right">
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li><a class="is-active" href="DTransactions.jsp">Transactions</a></li>
        ...
        <div class="page-heading text-center">
            ...
            <div class="container ">
                ...
                <h1 class="page-title">Transactions<span class="title-under"></span></h1>
                ...
                <table id="customers">
                    ...
                    <tbody>
                        <%
                            ...
                            try {
                                ResultSet rs = st.executeQuery("Select * from transaction where did='"+did+"' ORDER BY id DESC; ");
                                while (rs.next()) {
                        %>
                        <tr>
                            ...
                            <td><a href="reciept.jsp?id=<%=rs.getString("id")%>" class="btn btn-success" style="color: white">Generate Receipt</a></td>
                            <%                                        }
                                } catch (Exception ex) {
                                    ex.printStackTrace();
                                }
