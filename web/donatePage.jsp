                            ...
                            <div class="our-team ">
                                ...
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <% String cid=request.getParameter("id"); Connection
                                            con=SQLconnection.getconnection(); Statement st=con.createStatement();
                                            ResultSet rs=st.executeQuery("Select * from campaign where id='" + cid + "'");
                        if (rs.next()) {
                            int total = rs.getInt(" Amount"); int collected=rs.getInt("AmountCol"); if (collected>=
                                            total && total > 0) {
                                            response.sendRedirect("DonorViewCampaign.jsp?GoalReached");
                                            return;
                                            }
                                            } else {
                                            response.sendRedirect("DonorViewCampaign.jsp?InvalidCampaign");
                                            return;
                                            }
                                            %>
                                            <div class="modal-body col-md-6" style="margin-left: 280px">
                                                ...
                                                <form class="form-donation" action="donate" method="post">
                                                    ...
                                                    <h3 class="title-style-1 text-center">Thank you for your donation
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <input type="text" class="form-control" name="cname"
                                                                readonly="" value="<%=rs.getString(" cname")%>"
                                                            id="amount" >
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <input type="text" class="form-control" name="campName"
                                                                readonly="" value="<%=rs.getString(" campName")%>"
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <textarea cols="30" rows="4" class="form-control"
                                                                readonly="" name="CampDes"
                                                                placeholder="Additional note*"><%=rs.getString("CampDes")%></textarea>
                                                        </div>
                                                    </div>
                                                    <input type="hidden" value="<%=rs.getString(" id")%>"
                                                    name="campaign_id">
                                                    <input type="hidden" value="<%=rs.getString(" cid")%>"
                                                    name="charity_id">
                                                    <div class="row">
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <input class="form-group" type="radio" id="age1"
                                                                name="payment" required="" value="Net Banking">
                                                            <label for="age1">Net Banking</label><br>
                                                            <input class="form-group" type="radio" id="age2"
                                                                name="payment" required="" value="Credit/Debit">
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <input type="text" class="form-control" name="amount"
                                                                required="" placeholder="Donation Amount*">
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                ...
                                                <div class="footer-col">
                                                    ...
                                                    <h4 class="footer-title">About us <span class="title-under"></span>
                                                    </h4>
