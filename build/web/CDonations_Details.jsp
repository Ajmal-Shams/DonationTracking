<%-- 
    Document   : CDonations_Details
    Created on : Nov 21, 2022, 12:47:49 PM
    Author     : Murthi
--%>
                ...
                <table id="customers">
                    ...
                    <tbody>
                        <%
                            ...
                            try {
                                ResultSet rs = st.executeQuery("Select * from transaction where charity_id='"+cid+"' And donationStatus='Approved'");
                                while (rs.next()) {
                        %>
                        <tr>
                            ...
                            <td ><%=rs.getString("donationStatus")%></td>
                            <td ><%=rs.getString("spentFor")%></td>
                            <td ><%=rs.getString("spentOn")%></td>
                            <td><a href="donation_update.jsp?Tid=<%=rs.getString("Tid")%>" class="btn btn-primary">Update Info</a></td>
                            <%                                        }
                                } catch (Exception ex) {
                                    ex.printStackTrace();
                                }
