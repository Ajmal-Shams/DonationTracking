    ...
    <%@page import="java.sql.*" %>
        <%@page import="java.util.*" %>
            <%@page import="DonationTracking.SQLconnection" %>
                <% String q="SELECT * FROM charity_reg" +" WHERE panchayat_id=?"; ArrayList rows=new ArrayList(); String
                    ...
                    String[8]; r[0]=rs.getString("id"); r[1]=rs.getString("CName"); r[2]=rs.getString("CMailid");
                    r[3]=rs.getString("CPhone"); r[4]=rs.getString("Caddress"); r[5]=rs.getString("CAccStatus");
                    r[6]=rs.getString("CTor"); r[7]=r[0]; rows.add(r); } } }catch(Exception ex){ ex.printStackTrace();
                                ...
                                <%}%>
                                    ...
                                    <body>
                                                        ...
                                                        <div id="navbar" class="navbar-collapse collapse pull-right">
                                                            <ul class="nav navbar-nav">
                                                                ...
                                                                <li><a class="is-active"
                                                                        href="Charity_Details.jsp">Charity Details</a>
                                                                </li>
                                        ...
                                        <div class="page-heading text-center">
                                            <div class="container">
                                                <h1 class="page-title">Charity Details<span class="title-under"></span>
                                                </h1>
                                            </div>
                                        </div>
                                                                ...
                                                                <%for(int i=0;i<rows.size();i++){%>
                                                                    <%String[] r=(String[])rows.get(i);%>
                                                                        <tr>
                                                                            ...
                                                                            <td><a href="CharityActivate?id=<%=r[7]%>"
                                                                                    class="btn btn-success"
                                                                                    style="color:white">&nbsp;Activate</a>&nbsp;&nbsp;<a
                                                                                    href="CharityReject?id=<%=r[7]%>"
